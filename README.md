...
- 발표 ppt : https://www.canva.com/design/DAGDB7NFL04/XBayiicQKVjzqiziMN8BrA/edit?utm_content=DAGDB7NFL04&utm_campaign=designshare&utm_medium=link2&utm_source=sharebutton
...
- 프로젝트를 통해 배운 점
  - 한정된 기간 속에 최선의 아웃풋을 뽑아내기 위해 효율적으로 시간 배분하는 법. 
  - 서로 작업결과와 계획을 공유하는 것이 중요하다는 것.
  - 초반 기획 등 기초작업에 시간을 투자하는 것이 이후 프로젝트 진행 과정을 쉽게 만들어 준다는 점.
  - 팀원들 간의 원활한 소통을 위해서 코드 컨벤션 등이 중요하다는 점.
